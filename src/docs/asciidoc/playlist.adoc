...
include::{snippets}/playlist/modify-alert-day-time-success/http-request.adoc[]
include::{snippets}/playlist/modify-alert-day-time-success/request-fields.adoc[]

===== Response

include::{snippets}/playlist/modify-alert-day-time-success/http-response.adoc[]
include::{snippets}/playlist/modify-alert-day-time-success/response-fields.adoc[]
