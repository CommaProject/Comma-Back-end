...
include::{snippets}/user-detail/upload-profile-image-success/http-request.adoc[]
include::{snippets}/user-detail/upload-profile-image-success/request-cookies.adoc[]
include::{snippets}/user-detail/upload-profile-image-success/request-parts.adoc[]

===== Response

include::{snippets}/user-detail/upload-profile-image-success/http-response.adoc[]
include::{snippets}/user-detail/upload-profile-image-success/response-fields.adoc[]