...
import com.team.comma.domain.spotify.track.dto.TrackPlayCountRequest;
...
public class TrackPlayCountRepositoryTest {
    ...
    public void findTrackPlayCountByFriend() {
        ...
        Following following1 = Following.createFollowingFromTo(friend1 , user);
        Following following2 = Following.createFollowingFromTo(friend2 , user);
